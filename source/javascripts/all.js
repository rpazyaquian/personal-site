...
var ProjectCardList = require('./projectCardList.jsx');
...
var ProjectCardList = React.createClass({displayName: 'ProjectCardList',
  render: function() {

    var projectCards = this.props.data.map(function(card){
      return (
        React.createElement("li", {key: card.id}, 
          React.createElement(ProjectCard, {card: card})
        )
      );
    });

    return (
      React.createElement("ul", {className: "project-card-list"}, 
        projectCards
      )
    );
  }
